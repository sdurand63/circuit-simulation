...
## English description
This Python program, from a 1st year CPI academic project at CESI, simulates a full-scale Hot Wheels circuit, calculating lap times and performance metrics for 6 different car models.
